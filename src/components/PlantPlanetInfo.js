...
import '../components/HomePageInfo';




 function PlantPlanetInfo() {
    return (
...
<br />
    ...
    <div id="whydowehelp" className="p-4 text-dark rounded-3"><h1>What is Plant the Planet?</h1> </div>
<br />
...
<div id="whydowehelp" className="p-4 text-dark rounded-3"><h1>History of Plant the Planet</h1> </div>
    <br />
...
<img src="../images/plant-the-planet-2.jpg" alt="Plant the Planet 2"></img>
<p></p>
      </div>
</div>

<div id="howdowehelp" className="p-4 text-dark rounded-3">
                  <h1>Why is Plant the Planet Important?</h1> </div>
...
<div className="row">
    ...
    <img src="../plant-the-planet-3.jpg" alt="Plant the Planet 3"></img>
    <img src="../plant-the-planet-4.jpg" alt="Plant the Planet 4"></img>
    </div>
</div>
<br />
<br />
...
export default PlantPlanetInfo;
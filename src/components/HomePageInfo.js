            ...
            <div className="wetackle">
                <div class='left_half'>
                    <div className='container'>
                        <div className="col-md-12">
                            <h1>135 MILLION</h1>
                            <p className='hungerMessage'>are facing acute hunger worldwide</p>
                            <p className='hungerMessage'>UN, 2020</p>
                        </div>
                    </div>
                </div>
                ...
                <div class='right_half'>
                    <div className='container'>
                        <div className="col-md-12">
                            ...
                            <p className='tackleMessage'>We work to tackle the global issue of
                                poverty. </p>
                            <p className='tackleMessage'><span>&#8216;Around the world, 821 million people do

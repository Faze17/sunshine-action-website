         ...
         <div className="col-md-8">
            <div className="container">
               <div id="ourstory" className="p-4 text-dark rounded-3">
                  <h1>Sunshine Folding Container Houses</h1> </div>
                  <h3>Cheap – Mobile – Green – Durable – Beautiful – Quick & Easy assembly</h3>
        <br />


<div className="row">
    <div>
    <p>Our Sunshine Folding Container Houses consist of brand-new mobile containers. They are a green and economical solution to the housing crisis. Each container is made from new steel sheets and includes water-proof and fire-proof insulation. They have a minimum lifespan of 13-15 years or more, depending on local weather conditions and maintenance.</p>



<p>These homes are designed to provide a quick housing solution in natural disaster zones, or to provide extra accommodation to orphanages or care homes.</p>
...
export default BuildingProjectInfo;

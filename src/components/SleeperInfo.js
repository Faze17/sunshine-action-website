...
<div id="howdowehelp" className="p-4 text-dark rounded-3">
                  <h1>Projects Within the Street-Sleepers Program</h1> </div>
...
<p><u>Street-Sleepers Simulation in Schools:</u></p> 

<p>Sunshine Action have extended this project into schools in Hong Kong, 
...
<p>Bradbury School and Discovery College ESF have both advocated for the program inside of their schools 
    ...
    <img src="../images/street-sleepers-2.jpg" alt="Street Sleepers 2"></img>
<br />
<br />
...
<div className="row">
    ...
    <li>CEOs that have joined the Street-sleepers Program include Mr. Neil Harvey from Credit Suisse and Ms. Ligia Torres from BNP Paribas. Clifford Hart Jr. was the first Consul General of the United States to join the program, along with a team of volunteers from the U.S. Consulate. Many members of the U.S. Navy & Marines from different ships have also joined this program. </li>
      ...
      <img src="../images/street-sleepers-3.jpg" alt="Street Sleepers 3"></img>
</div>
<br />
<br />

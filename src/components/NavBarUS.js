...
<script src="https://cdn.jsdelivr.net/npm/bootstrap@5.1.0/dist/js/bootstrap.min.js" integrity="sha384-cn7l7gDp0eyniUwwAZgrzD06kc/tftFf19TOAs2zVinnD/C7E91j9yyk5//jjpt/" crossorigin="anonymous"></script>
  ...
  <div class="container-fluid">
    <Link class="navbar-brand" to="/"> <img src="/images/actual-logo.png" width="70" height="70"></img> <span>Sunshine Action USA</span></Link>
      ...
      <li class="nav-item">
        ...
        <li class="nav-item dropdown">
          <Link class="nav-link dropdown-toggle" to="our-work" id="navbarDropdownMenuLink" role="button" data-bs-toggle="dropdown" aria-expanded="false">
            ...
            <li><Link class="dropdown-item" to="reports">Reports</Link></li>
          </ul>
        </li>
        ...
        {/*<li class="nav-item dropdown">
          ...
          <ul class="dropdown-menu" aria-labelledby="navbarDropdownMenuLink">
            <li><Link class="dropdown-item" to="projects">USA</Link></li>

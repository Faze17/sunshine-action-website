...
function VoluntaryPage() {
 ...
 <div className="row">
    <div>
        <br />
    <p>Sunshine Action is always looking for new people to 
        get involved! One of the ways you can help is by 
        volunteering at one of our events. Follow our 
        social media accounts to find out when the next event is happening near you. </p>
    <br />

...
<br />
    ...
    <div id="whydowehelp" className="p-4 text-dark rounded-3"><h1>What is the Congenital Heart Disease Program?</h1> </div>
<br />
...
<div id="whydowehelp" className="p-4 text-dark rounded-3"><h1>What is CHD?</h1> </div>
    <br />
...
<div id="howdowehelp" className="p-4 text-dark rounded-3">
                  <h1>History of the CHD Program</h1> </div>
...
<div className="row">
    ...
    <p>Sunshine Action began this program in 2009. To date, 57 surgeries have been completed in China and 3 in Thailand. In China, patients are referred by Yunnan Youth Development Foundation, especially those patients who could not otherwise afford the surgeries. These cases are then assessed by hospitals and offered at a discounted price to Sunshine Action. The majority of surgeries are conducted in Guangzhou by two top A level hospitals:</p>
    <li>General Hospital of Guangzhou Military Command of PLA</li>
    <li>General Hospital of China People’s Armed Police Force General Hospital</li>
    <p>Other cases have occurred in Thailand and were referred directly by the Burma Children’s Medical Fund (BCMF), an organization which aids Burmese refugees in Mae Sot Thailand. These surgeries were then completed in Chiang Mai Hospital, with the cost covered by Sunshine Action.</p>
    <img src="../CHD-2.jpg" alt="CHD2"></img><img src="../CHD-3.jpg" alt="CHD3"></img>
    </div>
</div>
<br />
<br />
<div id="howdowehelp" className="p-4 text-dark rounded-3">
                  <h1>Patient Stories</h1> </div>
              
        <br />

<div className="row">
    <div>
        <img src="../mar-lu-kway.jpg" alt="Mar Lu Kway"></img>
        ...
        <img src="../kyaw-linn-naing.jpg" alt="Kyaw Linn Naing"></img>
